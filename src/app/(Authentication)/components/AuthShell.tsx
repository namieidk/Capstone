...
export function AuthShell({ mode, title, subtitle, children }: AuthShellProps) {
  return (
    <div className="grid min-h-svh lg:h-svh lg:overflow-hidden lg:grid-cols-2">
      <div className="flex flex-col p-6 md:p-10 lg:h-full lg:overflow-y-auto">
        <div className="flex w-full justify-center lg:justify-start">
          <Link href="/" className="flex w-fit items-center gap-2.5 text-[1.05rem] font-semibold text-navy">
