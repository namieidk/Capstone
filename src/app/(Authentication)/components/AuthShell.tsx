...
export function AuthShell({ mode, title, subtitle, children }: AuthShellProps) {
  return (
    <div className="auth-theme grid min-h-svh lg:h-svh lg:grid-cols-2">
      ...
      <main className="auth-form-bg flex min-h-svh flex-col lg:h-full lg:min-h-0">
        <ScrollArea className="h-full w-full [&_[data-slot=scroll-area-viewport]>div]:min-h-full [&_[data-slot=scroll-area-viewport]>div]:flex! [&_[data-slot=scroll-area-viewport]>div]:flex-col!">
