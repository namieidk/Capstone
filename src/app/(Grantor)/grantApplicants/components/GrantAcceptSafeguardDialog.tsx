...
export function GrantAcceptSafeguardDialog({ warningText, onClose, onConfirm }: GrantAcceptSafeguardDialogProps) {
  return (
    <AlertDialog open={warningText !== null} onOpenChange={(open) => !open && onClose()}>
