...
export function GrantRejectDialog({
  open,
  acting,
  onClose,
  onConfirm,
}: GrantRejectDialogProps) {
        ...
        <div className="flex flex-col gap-3 py-2">
          <div className="rounded-xl border border-border/80 bg-muted/30 p-3 text-xs text-muted-foreground">
            ...
            <p className="italic leading-relaxed">
              &ldquo;Thank you for applying for our scholarship program. After careful evaluation of all submissions, your application was not selected for this cycle.&rdquo;
            </p>
