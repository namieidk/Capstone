    ...
    <div style={{ height: "100vh", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      <div style={{ ...s.mainContent, padding: s.mainContent.padding, flexGrow: 1, minHeight: 0, overflowY: "auto" }}>
        <div style={{ maxWidth: 760, margin: "0 auto", padding: "24px 4px 60px" }}>
          ...
          <SettingsSection
            title="Approvals"
            subtitle="Control how scholar disbursements get approved"
          ...
          >
            <ActionRow
              ...
              label="Transfer account access"
              desc="Hand off this company's ViaScholar account to another representative."
              buttonLabel="Transfer access"
              tone="danger"
            />
          </SettingsSection>
        </div>
