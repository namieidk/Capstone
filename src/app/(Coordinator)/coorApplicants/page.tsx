...
export default function ApplicantsPage() {
  ...
  return (
    <div>
      ...
      {/* ---------------- Filter dropdown, right-aligned, matching Admin Archive's top row spacing ---------------- */}
      ...
      {/* ---------------- Table card, same shell/header/th/td treatment as Admin Archive ---------------- */}
      <div style={{ background: WHITE, border: BORDER_SUBTLE, borderRadius: 18, boxShadow: SHADOW_SM, padding: "22px 22px 8px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
          <p style={{ fontSize: "1.15rem", fontWeight: 700, color: NAVY, fontFamily: "'Inter', sans-serif" }}>Applicants</p>
