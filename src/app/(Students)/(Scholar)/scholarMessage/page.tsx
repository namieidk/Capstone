...
import { SendIcon, CONVERSATIONS, AMBER_BG, s } from "@/components/ScholarShared";
...
export default function ScholarMessagePage() {
  ...
  return (
    <div style={s.pageWrap}>
      <h2 style={s.pageHeading}>Messages</h2>
      <p style={s.pageSub}>Talk with your coordinator and fellow scholars.</p>

      <div className="vd-messages-shell" style={s.messagesShell}>
        <div className="vd-convo-list-col" style={s.convoListCol}>
          {convos.map((c) => (
            <button
              key={c.id}
