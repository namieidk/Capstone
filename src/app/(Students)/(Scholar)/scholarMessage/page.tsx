...
// ---- local tokens (mirrors coordinator message styling) ----
const GREEN = "#4C9A6A";
const BAD = "#C24A3B";
    ...
    <div style={{ height: "100vh", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      <header style={{ ...s.topbar, flexShrink: 0 }}>
        ...
        <div>
          ...
          <p style={s.topbarSub}>Talk with your coordinator and fellow scholars.</p>
        </div>
      </header>
                    ...
                    <div style={{ position: "relative", flexShrink: 0 }}>
                      ...
                      <span
                        style={{
                          ...
                          height: 10,
                          borderRadius: "50%",
                          background: c.unread > 0 ? GREEN : "#c2c2bd",
                  ...
                  <div style={{ maxWidth: "72%" }}>
                    <div
                      style={{
                        ...
                        fontSize: "0.9rem",
                        lineHeight: 1.55,
                        boxShadow: m.from === "me" ? "0 4px 14px rgba(30,58,95,0.18)" : "none",
                      }}
                    >
                      {m.text}
                    </div>
