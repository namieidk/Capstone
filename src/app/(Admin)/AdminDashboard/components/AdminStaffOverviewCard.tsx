      ...
      <CardContent className="p-4 sm:p-5">
        <div className="flex items-center justify-between pb-3 border-b border-line">
          <div className="flex items-center gap-2">
            <div className="flex size-7 items-center justify-center rounded-lg bg-[#0a4f42]/10 text-[#0a4f42]">
              <Users className="size-4" />
            </div>
            <div>
              <h3 className="text-sm sm:text-[15px] font-bold text-foreground">Staff & Employee Access</h3>
              <p className="text-xs text-muted-foreground">Active coordinators, grantors, and administrators.</p>
            </div>
          </div>
          <Link href="/AdminEmployee">
            <Button
              variant="ghost"
              size="sm"
