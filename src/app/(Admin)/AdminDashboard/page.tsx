        ...
        <main style={{ width: "100%" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 18, marginBottom: 20 }}>
            {QUICK_ACTIONS.map((qa, i) => {
              ...
              return (
                // biome-ignore lint/a11y/useSemanticElements: quick action tile reads as a button and navigates; markup is a styled tile container
                <div
                  key={qa.label}
                  className="tile"
            ...
            >
              ...
              >
                ...
                <div style={{ textAlign: "right" }}>
                  <p style={{ margin: "0 0 8px", fontSize: 15.5, color: "#7a7a74", fontWeight: 600 }}>
                    Approved scholars
                  </p>
                  <p
                    style={{ margin: 0, fontSize: 40, fontWeight: 700, color: NAVY, fontFamily: "'Inter', sans-serif" }}
                  >
                    87
                  </p>
                </div>
              ...
              <svg viewBox={`0 0 ${W} 260`} width="100%" height={280} style={{ display: "block", marginTop: 14 }}>
                <title>Approved vs submitted scholars over time</title>
                <defs>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", marginTop: 8 }}>
                {WEEK_DAYS.map((d) => (
                  <span key={d} style={{ fontSize: 13, color: "#9a9a94" }}>
                    {d}
                  </span>
                ))}
              </div>
              ...
              {ACTIVITY.map((a, i) => {
                ...
                return (
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                      <span
                        style={{ width: 10, height: 10, borderRadius: "50%", background: toneColor, flexShrink: 0 }}
                      />
                      <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1.3fr 1fr", gap: 18 }}>
              ...
              >
                <svg width="98" height="98" viewBox="0 0 90 90">
                  <title>{`Renewal rate: ${renewalPct}%`}</title>
                  ...
                  <circle
                    ...
                    strokeLinecap="round"
                    strokeDasharray={c}
                    strokeDashoffset={c - (renewalPct / 100) * c}
