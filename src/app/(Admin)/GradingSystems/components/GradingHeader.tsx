    ...
    <header className="sticky top-0 z-30 flex items-center justify-between gap-3 border-b border-line bg-white px-5 py-3.5 md:px-8">
      <div className="flex min-w-0 items-center">
        ...
        <div className="min-w-0">
          <h1 className="truncate text-xl font-bold text-navy!">Grading Systems</h1>
          <p className="truncate text-sm text-muted-foreground">Per-school grading scales used to evaluate grades.</p>
        </div>
      </div>
      <div className="flex shrink-0 items-center gap-3">
        <div className="hidden h-10 w-[198px] items-center gap-2 rounded-full border border-line bg-tint px-3.5 md:flex">
