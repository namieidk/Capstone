      ...
      <div className="meeting-grid">
        ...
        <div style={{ background: WHITE, border: BORDER_SUBTLE, borderRadius: 20, boxShadow: SHADOW_SM, padding: "28px 30px 32px" }}>
          ...
          {dayMeetings.length === 0 ? (
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "64px 0", color: "#9a9a94", gap: 10 }}>
              <CalendarIcon />
              <p style={{ fontSize: "0.92rem" }}>No meetings scheduled for this day.</p>
              <button onClick={() => { setForm((f) => ({ ...f, date: selectedDateKey })); setShowBookModal(true); }} style={{ ...s.continueBtnSmall, marginTop: 6 }}>
        ...
        <aside style={{ background: WHITE, border: BORDER_SUBTLE, borderRadius: 20, boxShadow: SHADOW_SM, padding: "24px 24px 26px", position: "sticky", top: 24 }}>
          ...
          <div style={{ marginTop: 22, display: "flex", flexDirection: "column", gap: 10 }}>
            <button className="book-btn" onClick={() => { setForm((f) => ({ ...f, date: selectedDateKey })); setShowBookModal(true); }} style={{ ...s.continueBtn, display: "flex", alignItems: "center", justifyContent: "center", gap: 8, width: "100%" }}>
              <CalendarIcon /> Book a meeting
            </button>
          </div>
          ...
          <div style={s.drawerPanel} onClick={(e) => e.stopPropagation()}>
            <div style={{ ...s.drawerHeader, marginBottom: 22 }}>
              <div style={{ flexGrow: 1 }}>
                ...
                <p style={s.drawerMeta}>{combined.length} total, hosted and invited</p>
              </div>
