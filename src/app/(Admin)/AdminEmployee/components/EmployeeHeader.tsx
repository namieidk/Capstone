    ...
    <header className="sticky top-0 z-30 flex items-center justify-between gap-3 border-b border-line bg-white px-5 py-3.5 md:px-8">
      <div className="flex min-w-0 items-center">
        ...
        <div className="min-w-0">
          <h1 className="truncate text-xl font-bold text-navy!">Employee</h1>
          <p className="truncate text-sm text-muted-foreground">
            Coordinators, HR staff, and partner-company employees on file.
          </p>
        </div>
      </div>
      <div className="flex shrink-0 items-center gap-3">
        <div className="hidden h-10 w-49.5 items-center gap-2 rounded-full border border-line bg-tint px-3.5 md:flex">
