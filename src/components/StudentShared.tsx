...
export const ACTIVITY_FEED: ActivityItem[] = [
  {
    icon: <MailIcon small />,
    text: "Engr. Paolo R. sent you a message about your application requirements.",
    time: "12 minutes ago",
  },
  {
    icon: <ForumIcon small />,
    text: 'New reply on your thread "Tips for the coordinator interview?"',
    time: "1 hour ago",
  },
...
export const APPLICATION_STAGES: ApplicationStage[] = [
  { key: "submitted", title: "Submitted", date: "Jun 12, 2026", desc: "Your application and documents were received." },
  {
    ...
    title: "Under review",
    date: "Jun 18, 2026",
    desc: "A coordinator is verifying your documents and eligibility.",
  },
  {
    key: "interview",
    title: "Interview",
    date: "Jun 26, 2026",
    desc: "Brief call with a ViaScholar coordinator to confirm details.",
  },
