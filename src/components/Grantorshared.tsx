...
export const SHADOW_SM = "0 8px 20px -10px rgba(20,33,58,0.12)";
export const BORDER_SUBTLE = `1px solid ${LINE}`;
...
export const PAYMENT_STATUS_COLORS: Record<
  PaymentRequest["status"] | PaymentRecord["status"],
...
export const GRANT_REPORT_KPIS = [
  ...
  { label: "Non-allocated", value: "₱2,000", kpi: "0.2% remaining", kpiDirection: "up" as const },
  {
    ...
    value: String(FUNDED_SCHOLARS.length),
    kpi: "+1 this quarter",
...
export const CONVERSATIONS: Conversation[] = [
  {
    id: "coordinator",
    name: "Engr. Paolo R.",
    role: "HR Coordinator, ViaScholar",
    initials: "PR",
    ...
    messages: [
      {
        from: "them",
        text: "Hi, just confirming your company's Q3 scholar batch is ready for review.",
        time: "10:02 AM",
      },
      { from: "me", text: "Thanks Paolo, please send it over whenever it's ready.", time: "10:05 AM" },
      {
        from: "them",
        text: "Sure, I'll send over the Q3 disbursement batch for your approval by Friday.",
        time: "10:07 AM",
      },
    ],
  },
  {
    ...
    messages: [
      ...
      {
        from: "them",
        text: "Carlo Bautista's GWA has dropped below threshold — flagging for your visibility.",
        time: "9:12 AM",
      },
    ],
  },
...
export const ACTIVITY_FEED = [
  {
    ...
    text: "Q3 disbursement schedule confirmed by the coordinator office.",
    time: "20 minutes ago",
  },
  {
    icon: <MonitorIcon />,
    text: "Carlo Bautista's GWA dropped below the retention threshold — flagged for review.",
    time: "1 hour ago",
  },
  { icon: <InterviewIcon />, text: "Meeting confirmed with Engr. Paolo R. for Jul 8, 3:00 PM.", time: "3 hours ago" },
  {
    icon: <MailIcon small />,
    text: "Coordinator replied to your question about the Q3 payment batch.",
    time: "5 hours ago",
  },
  {
    icon: <CheckCircleIcon small />,
    text: "Donna Mae Fayloga's grade report was verified successfully.",
    time: "Yesterday",
  },
];
