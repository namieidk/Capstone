...
export const s: Record<string, CSSProperties> = {
  ...
  searchBox: { display: "flex", alignItems: "center", gap: 8, background: TINT, border: `1px solid ${LINE}`, borderRadius: 999, padding: "7px 14px", width: 198 },
  searchInput: { background: "none", fontSize: "0.82rem", color: "#2B2B28", width: "100%", outline: "none" },
  bellBtn: { position: "relative", width: 36, height: 36, borderRadius: "50%", background: TINT, display: "flex", alignItems: "center", justifyContent: "center" },
  bellDot: { position: "absolute", top: 8, right: 8, width: 7, height: 7, borderRadius: "50%", background: AMBER, border: `2px solid ${TINT}` },
  ...
  pipelineValue: { fontFamily: "'Inter', sans-serif", fontSize: "2.1rem", fontWeight: 700, color: NAVY, lineHeight: 1, marginBottom: 14 },
  ...
  profileAvatar: { width: 88, height: 88, borderRadius: "50%", border: `4px solid ${WHITE}`, color: "#6b5220", fontFamily: "'Inter', sans-serif", fontWeight: 700, fontSize: "1.8rem", display: "flex", alignItems: "center", justifyContent: "center", background: AMBER_BG },
