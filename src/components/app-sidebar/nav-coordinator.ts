...
export const COORDINATOR_NAV_ITEMS: NavItem[] = [
  ...
  { key: "applicants", label: "Applicants", icon: Users, href: "/CoordinatorApplicants", badge: 12 },
  { key: "meeting", label: "Meeting", icon: Calendar, href: "/CoordinatorMeeting", badge: 4 },
  { key: "monitor", label: "Monitor", icon: Activity, href: "/CoordinatorMonitor" },
  { key: "payment", label: "Payment", icon: CreditCard, href: "/CoordinatorPayment", badge: 2 },
  ...
  { key: "message", label: "Message", icon: Mail, href: "/CoordinatorMessage", badge: 3 },
