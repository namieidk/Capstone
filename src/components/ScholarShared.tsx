  ...
  return (
    <style>{`
      ...
      /* Scoped the same way as the button reset above: ShadCN controls keep
         ...
         and radius override. */
      .vd button:not([data-slot]):focus-visible,
      .vd a:focus-visible,
      .vd input:not([data-slot]):focus-visible,
      .vd select:not([data-slot]):focus-visible,
      .vd textarea:not([data-slot]):focus-visible {
      ...
      /* ---- Layout: natural scrolling, no viewport clipping ----
         The old .vd-main / .vd-snap-section rules used height: 100vh +
         scroll-snap + min-height: 100vh, which clipped tall content.
         The shadcn Sidebar handles its own pinning (sticky) and mobile
         (Sheet), so the legacy .vd-sidebar fixed-position overrides are
         removed — they only fought it. */
      .vd-app-shell { display: flex; min-height: 100vh; align-items: flex-start; }
      .vd-main { flex-grow: 1; min-width: 0; display: flex; flex-direction: column; }
      .vd-snap-section,
      .vd-snap-section-table { padding: 0; }

      /* ---- Subtle, consistent interaction states ---- */
      .vd table tbody tr { transition: background-color 0.12s ease; }
      .vd table tbody tr:hover { background-color: #F7F9FB; }

      .vd-card-interactive { transition: box-shadow 0.15s ease, transform 0.15s ease; cursor: pointer; }
      .vd-card-interactive:hover { box-shadow: 0 10px 28px rgba(20, 33, 58, 0.10); transform: translateY(-2px); }

      .vd-nav-item { transition: background-color 0.12s ease, color 0.12s ease; }
      .vd-nav-item:hover { background-color: #EEF1F5; }
...
export const ACTIVITY_FEED: ActivityItem[] = [
  {
    icon: <MailIcon small />,
    text: "Engr. Paolo R. sent you a message about your Q3 disbursement.",
    time: "12 minutes ago",
  },
...
export const GRADE_CERTIFICATES: SemesterCertificate[] = [
  { term: "Mid-year, 2025–2026", file: "not yet submitted", size: "—", submittedDate: "—", status: "not_submitted" },
  {
    ...
    file: "cert_grades_1stsem_2025.pdf",
    size: "1.1 MB",
  ...
  },
  {
    ...
    file: "cert_grades_2ndsem_2024.pdf",
    size: "980 KB",
...
export const CONVERSATIONS: Conversation[] = [
  {
    ...
    messages: [
      ...
      {
        from: "me",
        text: "Hi sir Paolo, thank you for confirming! Is that the same amount as last quarter?",
        time: "10:05 AM",
      },
      {
        from: "them",
        text: "Yes, same amount, ₱8,000. It should reflect in your registered bank account.",
        time: "10:07 AM",
      },
      {
        from: "me",
        text: "Noted po, thank you! One more thing — can I still update my address on file?",
        time: "10:09 AM",
      },
  ...
  },
  {
    ...
    messages: [
      ...
      {
        from: "them",
        text: "Not for now — we'll reach out if anything else is needed before the interview.",
...
export const MEETINGS_HOSTING: HostedMeeting[] = [
  {
    id: 1,
    title: "Study plan check-in",
    date: "Jul 8, 2026",
    time: "3:00 PM",
    invitee: "Engr. Paolo R.",
    status: "confirmed",
  },
];
...
export const PROFILE_DOCUMENTS: ProfileDocument[] = [
  ...
  {
    label: "Proof of family member's employment",
    file: "employment_certificate.jpg",
    size: "780 KB",
    status: "verified",
  },
...
export function SettingsIcon() {
  return (
    ...
    >
      ...
      <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 1 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.6 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 1 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.6a1.65 1.65 0 0 0 1-1.51V3a2 2 0 1 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9c.36.51.99.9 1.51 1H21a2 2 0 1 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z" />
    </svg>
  );
}
...
export function HeartIcon({ filled }: { filled?: boolean }) {
  return (
    <svg
      ...
      height="16"
      viewBox="0 0 24 24"
      fill={filled ? "#C9943D" : "none"}
      stroke={filled ? "#C9943D" : "currentColor"}
      strokeWidth="2"
      aria-hidden="true"
      focusable="false"
    >
...
export const s: Record<string, CSSProperties> = {
  ...
  floatingMobileToggle: {
    ...
    alignItems: "center",
    justifyContent: "center",
    boxShadow: "0 8px 20px -10px rgba(20,33,58,0.25)",
  },
  topbarGreeting: { fontSize: "1.22rem", fontWeight: 700, color: NAVY, marginBottom: 2, lineHeight: 1.2 },
