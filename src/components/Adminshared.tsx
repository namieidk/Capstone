...
export function HomeIcon() {
  return <Home size={19} strokeWidth={2} />;
}
export function PeopleIcon() {
  return <Users size={19} strokeWidth={2} />;
}
export function MonitorIcon() {
  return <Activity size={19} strokeWidth={2} />;
}
export function ReportsIcon() {
  return <BarChart3 size={19} strokeWidth={2} />;
}
export function ArchiveIcon() {
  return <Archive size={19} strokeWidth={2} />;
}
export function MailIcon({ small }: { small?: boolean }) {
  return <Mail size={small ? 16 : 19} strokeWidth={2} />;
}
export function SettingsIcon() {
  return <Settings size={19} strokeWidth={2} />;
}
export function ProfileIcon() {
  return <User size={19} strokeWidth={2} />;
}
export function ForumIcon() {
  return <MessageCircle size={19} strokeWidth={2} />;
}
export function BriefcaseIcon() {
  return <Briefcase size={19} strokeWidth={2} />;
}
export function CalendarIcon() {
  return <Calendar size={19} strokeWidth={2} />;
}
export function CheckCircleIcon({ small }: { small?: boolean }) {
  return <CheckCircle2 size={small ? 16 : 19} strokeWidth={2} />;
}
export function XCircleIcon() {
  return <XCircle size={16} strokeWidth={2} />;
}
export function BellIcon() {
  return <Bell size={19} strokeWidth={2} color={NAVY} />;
}
export function SearchIcon() {
  return <Search size={16} strokeWidth={2} color="#7a7a74" />;
}
export function MenuIcon() {
  return <Menu size={20} strokeWidth={2} color={NAVY} />;
}
export function LogoutIcon() {
  return <LogOut size={16} strokeWidth={2} />;
}
export function ArrowRightIcon() {
  return <ArrowRight size={14} strokeWidth={2} />;
}
export function GradCapIcon() {
  return <GraduationCap size={16} strokeWidth={2} color="white" fill="white" />;
}
export function SendIcon() {
  return <Send size={17} strokeWidth={2} />;
}
export function CameraIcon() {
  return <Camera size={16} strokeWidth={2} color="white" />;
}
...
export function TrendDownIcon() {
  return <TrendingDown size={14} strokeWidth={2} />;
}
export function HeartIcon({ filled }: { filled?: boolean }) {
  return <Heart size={16} strokeWidth={2} fill={filled ? AMBER : "none"} color={filled ? AMBER : "currentColor"} />;
}
export function CommentIcon() {
  return <MessageSquare size={16} strokeWidth={2} />;
}
export function TrashIcon() {
  return <Trash2 size={15} strokeWidth={2} />;
}
export function PaymentsIcon() {
  return <CreditCard size={19} strokeWidth={2} />;
}
...
export const SCHOLARS_DIRECTORY: ScholarRecord[] = [
  {
    ...
    track: "Academic",
    gwa: 92.6,
    coordinator: "Engr. Paolo Reyes",
    joined: "Jun 2024",
    email: "d.fayloga.543617@umindanao.edu.ph",
    phone: "0986 543 216",
    address: "Kabacan St, Ecoland, Davao City",
    health: "good",
  },
  {
    id: 2,
    ...
    year: "4th year",
    track: "Returning Scholar",
    gwa: 94.2,
    coordinator: "Engr. Paolo Reyes",
    joined: "Jun 2022",
    email: "mariella.s@umindanao.edu.ph",
    phone: "0917 220 4471",
  ...
  },
  {
    ...
    track: "Returning Scholar",
    gwa: 93.4,
    coordinator: "Jenny Avila",
    joined: "Jun 2023",
    email: "patricia.lim@usep.edu.ph",
    phone: "0915 442 8810",
  ...
  },
  {
    ...
    course: "BS Nursing",
    year: "1st year",
    track: "Financial Need",
    gwa: 88.5,
    coordinator: "Jenny Avila",
    joined: "Jun 2026",
    email: "reign.p@umindanao.edu.ph",
    phone: "0933 671 4420",
...
export const EMPLOYEES: EmployeeRecord[] = [
  {
    ...
    initials: "PR",
    role: "HR Coordinator",
    department: "ViaScholar Operations",
    type: "Coordinator",
    status: "Active",
    joined: "Mar 2022",
  ...
  },
  {
    ...
    status: "Active",
    joined: "Jan 2024",
    email: "jenny.avila@viascholar.org",
  },
  {
    id: 3,
    name: "Mark Villaroel",
    initials: "MV",
    role: "Documents Reviewer",
    department: "ViaScholar Operations",
    type: "Coordinator",
    status: "On leave",
    joined: "Aug 2023",
    email: "mark.villaroel@viascholar.org",
  },
  {
    id: 4,
    name: "Liza Tan",
    ...
    department: "Cawayan River Dev. Corp.",
    type: "Partner Employee",
    status: "Active",
    joined: "Feb 2019",
    email: "liza.tan@crdc.com.ph",
  },
  {
    id: 5,
    name: "Roberto Cruz",
    ...
    status: "Active",
    joined: "Nov 2020",
    email: "roberto.cruz@crdc.com.ph",
  },
  {
    id: 6,
    name: "Engr. Paolo R.",
    initials: "PR",
    role: "HR Coordinator",
    department: "Partner Company A",
    type: "Partner Employee",
    status: "Active",
    joined: "May 2021",
    email: "p.r@partnerco-a.com",
  },
  {
    id: 7,
    name: "Samantha Reyes",
    ...
    status: "Active",
    joined: "Jun 2025",
    email: "samantha.reyes@viascholar.org",
  },
];
...
export const ORG_KPIS: OrgKpi[] = [
  ...
  {
    label: "Coordinators",
    value: EMPLOYEES.filter((e) => e.type === "Coordinator").length,
    kpi: "+1",
    kpiDirection: "up",
  },
...
export const ADMIN_ACTIVITY_FEED = [
  {
    icon: <CheckCircleIcon small />,
    text: "Jenny Avila accepted Reign P. into the Financial Need track.",
    time: "18 minutes ago",
  },
...
export const MEETINGS_HOSTING: HostedMeeting[] = [
  {
    ...
    date: "Jul 2, 2026",
    time: "9:00 AM",
    invitee: "All coordinators",
    status: "confirmed",
  },
  {
    id: 2,
    title: "Partner company onboarding call",
    date: "Jul 5, 2026",
    time: "2:00 PM",
    invitee: "Cawayan River Dev. Corp.",
    status: "confirmed",
  },
];
...
export const FORUM_POSTS: ForumPost[] = [
  ...
  },
  {
    ...
    time: "5h ago",
    text: "Tips for maintaining 90%+ GWA? Struggling a bit balancing my thesis prep with regular coursework this term.",
    likes: 22,
    comments: 9,
    liked: true,
  },
...
export const CONVERSATIONS: Conversation[] = [
  {
    ...
    messages: [
      {
        from: "me",
        text: "Hi Paolo, can you send me this week's applicant numbers before the budget review?",
        time: "9:40 AM",
      },
  ...
  },
  {
    ...
    messages: [
      {
        from: "them",
        text: "Good morning! Just an update — Reign P. has been accepted into the Financial Need track.",
        time: "8:15 AM",
      },
  ...
  {
    id: "crdc",
    name: "Cawayan River Dev. Corp.",
    role: "Partner company HR",
    initials: "CR",
    ...
    messages: [
      {
        from: "them",
        text: "Hi Atty. Castillo, we'd like to discuss increasing our scholarship slots for next year.",
        time: "Yesterday, 3:00 PM",
      },
      {
        from: "me",
        text: "Happy to. Let's set up a call — I've proposed Jul 5 at 2:00 PM on the calendar.",
...
export const ADMIN_PAYMENT_RECORDS: AdminPaymentRecord[] = [
  ...
  },
  {
    ...
    name: "Mariella S.",
    initials: "MS",
    course: "BS Accountancy, 4th year",
    coordinator: "Engr. Paolo Reyes",
    amount: 8000,
    term: "Q3 2026",
    scheduledDate: "Jul 15, 2026",
  ...
  },
  {
    ...
    name: "Patricia Lim",
    initials: "PL",
    course: "BS Accountancy, 3rd year",
    coordinator: "Jenny Avila",
    amount: 8000,
    term: "Q3 2026",
    scheduledDate: "Jul 15, 2026",
  ...
  },
  {
    ...
    name: "Carlo Bautista",
    initials: "CB",
    course: "BS Civil Engineering, 3rd year",
    coordinator: "Jenny Avila",
    amount: 8000,
    term: "Q3 2026",
    scheduledDate: "Jul 15, 2026",
...
export function Field({ label, required, children }: FieldProps) {
  return (
    <div style={s.fieldWrap}>
      {/* biome-ignore lint/a11y/noLabelWithoutControl: generic Field wrapper — the control is the children passed at each call site */}
...
export function TabButton({ active, onClick, children }: TabButtonProps) {
  return (
    <button
      type="button"
      onClick={onClick}
      style={{ ...s.tabButton, color: active ? NAVY : "#8a8a84", borderBottomColor: active ? AMBER : "transparent" }}
    >
      {children}
    </button>
  );
...
export const s: Record<string, CSSProperties> = {
  ...
  topbarGreeting: {
    fontSize: "clamp(1.1rem, 1vw + 0.92rem, 1.28rem)",
    fontWeight: 700,
    color: NAVY,
    marginBottom: 2,
    lineHeight: 1.2,
  },
  topbarSub: { fontSize: "0.82rem", color: "#7a7a74" },
  ...
  searchInput: { background: "none", fontSize: "0.82rem", color: "#2B2B28", width: "100%", outline: "none" },
  bellBtn: {
    position: "relative",
    width: 36,
    height: 36,
