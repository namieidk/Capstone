...
export const s: Record<string, CSSProperties> = {
  ...
  topbar: { position: "sticky", top: 0, zIndex: 30, background: WHITE, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 14, padding: "14px clamp(18px, 3.2vw, 32px)", borderBottom: `1px solid ${LINE}` },
  mobileToggle: { display: "none", marginRight: 8 },
  topbarGreeting: { fontSize: "clamp(1.1rem, 1vw + 0.92rem, 1.28rem)", fontWeight: 700, color: NAVY, marginBottom: 2, lineHeight: 1.2 },
